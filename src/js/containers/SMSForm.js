...
class SMSForm extends Component {
  constructor(props){
    ...
    this.state = {
      recipient: {
        value: this.props.countryCode[0].dial_code,
        required: true,
        error: false
      },
      message: {
  ...
  isValidPhoneNumber(inputtxt) {
    var phoneno = /^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4,6})$/;
  ...
  handlePhoneNoChange(name, value){
    this.setState({
      [name]: {
        value,
        error: !this.isValidPhoneNumber(value) || !value
      }
    })
  }
